...
public class SearchCookAdapter extends RecyclerView.Adapter<SearchCookAdapter.ViewHolder> {

    private Context context;
    private List<Cook> cookList;

    public SearchCookAdapter(Context context, List<Cook> cookList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_search_cook, parent, false);
